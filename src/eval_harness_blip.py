...
Usage:
  python eval_harness_blip.py --manifest data/esci1500_thumbs/manifest.csv \
      --img-dir data/esci1500_thumbs/img \
      --adv-dir runs/B2_full4method/eps16_1430/cogeo/img \
      --out-dir runs/R2_blip_rerank/cogeo --method-tag cogeo \
