...
CLIP = {
 "cogeo":    f"{BASE}/n3/runs/T3_scaleup/run4/eval/rank_cogeo_per_pair.csv",
 "pgd_bare": f"{BASE}/n3/runs/T3_scaleup/run4/eval/rank_pgd_bare_per_pair.csv",
 "coattack": f"{BASE}/n3/runs/B2_full4method/eps16_1430/eval/rank_coattack_per_pair.csv",
 "advclip":  f"{BASE}/n3/runs/B2_full4method/eps16_1430/eval/rank_advclip_per_pair.csv",
}
BLIP = {m: f"{BASE}/n3/runs/R2_blip_rerank/{m}/blip_rank_{m}_summary.json" for m in CLIP}
LAB = ["E", "S", "C", "I"]
out = {}
...
json.dump(out, open(f"{BASE}/n3/runs/R2_blip_rerank/clip_vs_blip_compare.json", "w"), indent=2)
print("WROTE", f"{BASE}/n3/runs/R2_blip_rerank/clip_vs_blip_compare.json")
print("HARVEST_OK")
