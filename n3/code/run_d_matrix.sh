...
CODE_DIR="${CODE_DIR:-${PROJECT_ROOT}/n3/code}"
RUNS_ROOT="${RUNS_ROOT:-${PROJECT_ROOT}/n3/runs}"
D_ROOT="${D_ROOT:-$RUNS_ROOT/D_vlm}"
CAP_DIR="${CAP_DIR:-${PROJECT_ROOT}/n3/data/vlm_captions}"
MANIFEST="${MANIFEST:-${PROJECT_ROOT}/n3/data/esci500_thumbs/manifest.csv}"
IMG_DIR="${IMG_DIR:-${PROJECT_ROOT}/n3/data/esci500_thumbs/img}"
GPU="${GPU:-0}"
EPS="${EPS:-16}"
ITERS="${ITERS:-200}"
